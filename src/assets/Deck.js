...
export var Deck = function () {
	...
	Deck.getCardDesc = function (cardNbr) {
		return (
			Deck.rankNames[Deck.getRank(cardNbr) - 2] +
			" of " +
			Deck.suitNames[Deck.getSuit(cardNbr)]
		);
	};
	...
	var _deck = new Array(constants.DECK_SIZE);
	for (var i = 0; i < constants.DECK_SIZE; i++) {
		_deck[i] = i;
	}
	...
	this.shuffle = function () {
		...
		for (i = constants.DECK_SIZE - 1; i > 0; i--) {
	...
	this.shuffle();
	//for (var z = 0; z < constants.DECK_SIZE; z++) {
